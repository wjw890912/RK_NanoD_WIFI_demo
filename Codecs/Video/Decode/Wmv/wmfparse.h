...
tWMCDecStatus LoadAudioObjectSize(
                    U32_WMC cbBuffer,
                    HWMCDECODER *phDecoder, U32_WMC dwPrevOffset);
...
/****************************************************************************/
tWMCDecStatus LoadCodecListObject(U32_WMC cbBuffer, HWMCDECODER *phDecoder);
/****************************************************************************/
...
/****************************************************************************/
tWMCDecStatus
LoadVirtualExtededStreamPropertiesExObject(
                    U32_WMC cbBuffer,
                    HWMCDECODER *phDecoder, U32_WMC Offset);
/****************************************************************************/
tWMCDecStatus LoadNewIndexObject(HWMCDECODER *phDecoder,
                    U64_WMC cbOffset,
                    U32_WMC cbBuffer
                    );
/****************************************************************************/
tWMCDecStatus LoadContentEncryptionEx2Object(
