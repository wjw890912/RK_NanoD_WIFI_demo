...
typedef struct _PSInfoBase {
	...
	//add by helun
	#ifdef GOOD
	int                   overlap[2][AAC_MAX_NSAMPS];
	#else
	int                   overlap[3][AAC_MAX_NSAMPS];
	#endif
...
*/
extern  HuffInfo *huffTabSpecInfo;
extern  signed short *huffTabSpec;
extern  HuffInfo *huffTabScaleFactInfo;
extern  signed short *huffTabScaleFact;
...
*/
extern  int *cos4sin4tab;
extern  int *cos4sin4tabOffset;
extern  int *cos1sin1tab;
extern  int *sinWindow;
extern  int *sinWindowOffset;
extern  int *kbdWindow;
extern  int *kbdWindowOffset;
extern  unsigned char *bitrevtab;
extern  int *bitrevtabOffset;
extern  int *twidTabEven;
extern  int *twidTabOdd;
