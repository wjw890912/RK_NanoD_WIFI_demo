...
#define APE_ZSP_PLATFORM

/*****************************************************************************************
Global includes
*****************************************************************************************/
#include "ape_nowindows.h"
...
//the following is added by hxd 20070319
//#define APE_ZSP_PLATFORM

//#ifdef APE_ZSP_PLATFORM
//typedef unsigned short   ape_uint16;
//typedef short            ape_int16;
//typedef unsigned long    ape_uint32;
//typedef long             ape_int32;
//typedef unsigned short   ape_uchar;
//typedef short            ape_char;
//typedef long             ape_BOOL;

//#define LENGTH(x)           x/2
//#define MEMOP_LEN(x)        x
//#define LEFTSHIFT1(x)       x*2
//#else
typedef unsigned short   ape_uint16;
typedef short            ape_int16;
typedef unsigned long    ape_uint32;
...
//#define SAFE_DELETE(POINTER) if (POINTER) {free(POINTER); POINTER = NULL; }
//#define SAFE_ARRAY_DELETE(POINTER) if (POINTER) { delete [] POINTER; POINTER = NULL; }
//#define SAFE_ARRAY_DELETE(POINTER) if (POINTER) { free(POINTER); POINTER = NULL; }
...
//#define ODN(NUMBER) { TCHAR cNumber[16]; _stprintf(cNumber, _T("%d\n"), ape_int32(NUMBER)); ODS(cNumber); }

//#define CATCH_ERRORS(CODE) try { CODE } catch(...) { }

#define RETURN_ON_ERROR(FUNCTION) {    ape_int32 nRetVal = FUNCTION; if (nRetVal != 0) { return nRetVal; } }
//#define RETURN_VALUE_ON_ERROR(FUNCTION, VALUE) { ape_int32 nRetVal = FUNCTION; if (nRetVal != 0) { return VALUE; } }
//#define RETURN_ON_EXCEPTION(CODE, VALUE) { try { CODE } catch(...) { return VALUE; } }

//#define THROW_ON_ERROR(CODE) { ape_int32 nRetVal = CODE; if (nRetVal != 0) throw(nRetVal); }
