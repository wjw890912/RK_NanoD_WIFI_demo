...
extern rk_err_t KeyDevInit(DEVICE_CLASS* dev);
extern rk_err_t KeyDevDeInit(DEVICE_CLASS* dev);
extern rk_size_t KeyDevRead(DEVICE_CLASS* dev,uint32* buffer,pFunc Rx_indicate);
extern rk_err_t KeyDevStop(HDC dev);
extern rk_err_t KeyRxIndicate(DEVICE_CLASS* dev, uint32 size);
extern rk_err_t KeyDevSuspend(DEVICE_CLASS* dev);
extern rk_err_t KeyDevResume(DEVICE_CLASS* dev);
