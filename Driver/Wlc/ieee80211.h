 ...
 */
static __inline int ieee80211_has_tods(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_fromds(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_a4(uint16 fc)
{
	uint16 tmp = (IEEE80211_FCTL_TODS | IEEE80211_FCTL_FROMDS);
	return (fc & tmp) == tmp;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_morefrags(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_retry(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_pm(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_moredata(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_protected(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_has_order(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_mgmt(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_ctl(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE)) ==
	       (IEEE80211_FTYPE_CTL);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_data(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_data_qos(uint16 fc)
{
	/*
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_data_present(uint16 fc)
{
	/*
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_assoc_req(uint16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_assoc_resp(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_reassoc_req(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_reassoc_resp(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_probe_req(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_probe_resp(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_beacon(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_atim(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_disassoc(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_auth(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_deauth(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_action(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_back_req(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_back(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_pspoll(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_rts(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_cts(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_ack(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_cfend(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_cfendack(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_nullfunc(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static __inline int ieee80211_is_qos_nullfunc(uint16 fc)
{
	return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
	       (IEEE80211_FTYPE_DATA | IEEE80211_STYPE_QOS_NULLFUNC);
}

__packed struct ieee80211s_hdr {
	uint8 flags;
	uint8 ttl;
	uint32 seqnum;
	uint8 eaddr1[6];
 ...
 */
__packed struct ieee80211_meshconf_ie {
	uint8 meshconf_psel;
	uint8 meshconf_pmetric;
	uint8 meshconf_congest;
	uint8 meshconf_synch;
	uint8 meshconf_auth;
	uint8 meshconf_form;
	uint8 meshconf_cap;
} ;
...
#if 0
typedef __packed struct ieee80211_mgmt {
	uint16 frame_control;
	uint16 duration;
	uint8 da[6];
	uint8 sa[6];
 ...
 */
__packed struct ieee80211_mcs_info {
...
struct ieee80211_country_ie_triplet {
	union {
		...
		typedef __packed struct {
			uint8 reg_extension_id;
			uint8 reg_class;
			uint8 coverage_class;
		}  ext;
	};
} ;
#endif
 ...
 * 4 addr: 2 + 2 + 2 + 4*6 = 30
 */
static __inline uint8 *ieee80211_get_qos_ctl(struct ieee80211_hdr *hdr)
{
 ...
 * field.
 */
static __inline uint8 *ieee80211_get_SA(struct ieee80211_hdr *hdr)
{
	if (ieee80211_has_a4(hdr->frame_control))
		return hdr->addr4;
 ...
 * field.
 */
static __inline uint8 *ieee80211_get_DA(struct ieee80211_hdr *hdr)
{
...
static __inline bool ieee80211_check_tim(struct ieee80211_tim_ie *tim,
				       uint8 tim_len, u16 aid)
{
	uint8 mask;
	uint8 index, indexn1, indexn2;
