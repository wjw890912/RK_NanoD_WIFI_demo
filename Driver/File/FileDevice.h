...
*---------------------------------------------------------------------------------------------------------------------
*/
#define _DRIVER_FILE_FILEDEVICE_COMMON_  __attribute__((section("driver_file_filedevice_read")))
...
extern rk_err_t FileDev_GetVolumeInf(HDC dev, uint32 VolumeNum, VOLUME_INF * pstVolumeInf);
