...
*******************************************************************************/
_DRIVER_MAILBOX_MAILBOXDEVICE_COMMON_
COMMON FUN void MailBoxDev_M2M_DmaIsr(void)
{
...
//    FW_RemoveModule(MODULE_ID_MAILBOX_DEV);
//#endif
...
#ifdef __SYSTEM_FWANALYSIS_FWANALYSIS_C__
    FW_ModuleOverlay(MODULE_ID_MAILBOX_DEV, MODULE_OVERLAY_CODE);
#endif
    //device init...
    gpstMailBoxDevISR[DevID] = NULL;
