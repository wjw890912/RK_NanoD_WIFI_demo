...
****************************************/
__attribute__((used, section("CG_UPNPAV_DMR_AVTRANSPORT_SERVICE_DESCRIPTION")))static char CG_UPNPAV_DMR_AVTRANSPORT_SERVICE_DESCRIPTION[] =
#if 0
...
BOOL cg_upnpav_dmr_avtransport_init(CgUpnpAvRenderer *dmr)
{
    ...
    if (!service)
     ...
     if(Cg_Get_Xml(XML_DMR_AVTRANSPORT_SERVICE_DESCRIPTION, &xml_buf,  &xml_len) == -1)
     {
        printf("xml get avtransport fail\n");
        return NULL;
     }
