...
//USBHUB SEG MODULE
extern uint32 Load$$USBHUB_DEV_CODE$$Base;
extern uint32 Image$$USBHUB_DEV_CODE$$Base;
extern uint32 Image$$USBHUB_DEV_CODE$$Length;

extern uint32 Load$$USBHUB_INIT_CODE$$Base;
extern uint32 Image$$USBHUB_INIT_CODE$$Base;
extern uint32 Image$$USBHUB_INIT_CODE$$Length;

extern uint32 Load$$USBHUB_SHELL_CODE$$Base;
extern uint32 Image$$USBHUB_SHELL_CODE$$Base;
extern uint32 Image$$USBHUB_SHELL_CODE$$Length;

//USBETH SEG MODULE
extern uint32 Load$$USBETH_DEV_CODE$$Base;
extern uint32 Image$$USBETH_DEV_CODE$$Base;
extern uint32 Image$$USBETH_DEV_CODE$$Length;

extern uint32 Load$$USBETH_INIT_CODE$$Base;
extern uint32 Image$$USBETH_INIT_CODE$$Base;
extern uint32 Image$$USBETH_INIT_CODE$$Length;

extern uint32 Load$$USBETH_SHELL_CODE$$Base;
extern uint32 Image$$USBETH_SHELL_CODE$$Base;
extern uint32 Image$$USBETH_SHELL_CODE$$Length;
...
FIRMWARE_INFO_T const ModuleInfo  =
{
    ...
    //MODUE_INFO_TABLE
    {
        (uint32)(MAX_MODULE_NUM),
        {
			...
			//USBHUB DEV SEG
            {
                (uint32)(&Load$$USBHUB_DEV_CODE$$Base),
                (uint32)(&Image$$USBHUB_DEV_CODE$$Base),
                (uint32)(&Image$$USBHUB_DEV_CODE$$Length),
            ...
            //USBHUB INIT SEG
            {
                (uint32)(&Load$$USBHUB_INIT_CODE$$Base),
                (uint32)(&Image$$USBHUB_INIT_CODE$$Base),
                (uint32)(&Image$$USBHUB_INIT_CODE$$Length),
            ...
            //USBHUB SHELL SEG
            {
                (uint32)(&Load$$USBHUB_SHELL_CODE$$Base),
                (uint32)(&Image$$USBHUB_SHELL_CODE$$Base),
                (uint32)(&Image$$USBHUB_SHELL_CODE$$Length),
			...
			//USBETH DEV SEG
            {
                (uint32)(&Load$$USBETH_DEV_CODE$$Base),
                (uint32)(&Image$$USBETH_DEV_CODE$$Base),
                (uint32)(&Image$$USBETH_DEV_CODE$$Length),
            ...
            //USBETH INIT SEG
            {
                (uint32)(&Load$$USBETH_INIT_CODE$$Base),
                (uint32)(&Image$$USBETH_INIT_CODE$$Base),
                (uint32)(&Image$$USBETH_INIT_CODE$$Length),
            ...
            //USBETH SHELL SEG
            {
                (uint32)(&Load$$USBETH_SHELL_CODE$$Base),
                (uint32)(&Image$$USBETH_SHELL_CODE$$Base),
                (uint32)(&Image$$USBETH_SHELL_CODE$$Length),
