...
int easy_setup_start()
{
    ...
    retry_times = 3;
    do {
        wwd_wifi_scan( WICED_SCAN_TYPE_PASSIVE, WICED_BSS_TYPE_INFRASTRUCTURE, &ssid, &bogus_scan_mac, NULL, &extparam, scan_result_callback, (wiced_scan_result_t **) &result_ptr, ws, WWD_STA_INTERFACE  );
