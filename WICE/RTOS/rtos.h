...
#define WICED_HARDWARE_IO_WORKER_THREAD           ((wiced_worker_thread_t*)&wiced_hardware_io_worker_thread)// ((wiced_worker_thread_t *) hardware_to_workTask_Enter)
#define WICED_NETWORKING_WORKER_THREAD              ((wiced_worker_thread_t*)&wiced_networking_worker_thread )//((wiced_worker_thread_t *)networkingTask_Enter)
