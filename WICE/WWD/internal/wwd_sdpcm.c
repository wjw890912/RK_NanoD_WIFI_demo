    ...
    switch ( packet->sdpcm_header.sw_header.channel_and_flags & 0x0f )
    {
        case CONTROL_HEADER:  /* IOCTL/IOVAR reply packet */
            ...
            if ( id == wwd_sdpcm_requested_ioctl_id )
            {
                ...
                WWD_LOG( ( "\nWcd:< Procd pkt 0x%08X: IOCTL Response (%d bytes)\n", (unsigned int)buffer, size ) );
        ...
        case DATA_HEADER:
            {
               ...
               // WWD_LOG( ( "Wcd:< Procd pkt 0x%08X: Data (%d bytes)\n", (unsigned int)buffer, size ) );
                ...
                else
                {
                    ...
                    /* rec packet to bottom of network stack */
...
wwd_result_t wwd_sdpcm_send_ioctl( sdpcm_command_type_t type, uint32_t command, /*@only@*/ wiced_buffer_t send_buffer_hnd, /*@special@*/ /*@out@*/ /*@null@*/  wiced_buffer_t* response_buffer_hnd, wwd_interface_t interface )  /*@allocates *response_buffer_hnd@*/  /*@defines **response_buffer_hnd@*/
{
    ...
    WWD_LOG( ( "\nWcd:> IOCTL pkt 0x%08X: cmd %d, len %d", (unsigned int)send_buffer_hnd, (int)command, (int)data_length ) );
 ...
 */
/*@null@*/ /*@exposed@*/
void* wwd_sdpcm_get_iovar_buffer( /*@special@*/ /*@out@*/ wiced_buffer_t* buffer, uint16_t data_length, const char* name )  /*@allocates *buffer@*/ /*@defines **buffer@*/
{
 ...
 */
/*@null@*/ /*@exposed@*/
void* wwd_sdpcm_get_ioctl_buffer( /*@special@*/ /*@out@*/ wiced_buffer_t* buffer, uint16_t data_length ) /*@allocates *buffer@*/  /*@defines **buffer@*/
{
