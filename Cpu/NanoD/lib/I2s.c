...
uint32 I2sGetInt(I2S_CHannel I2S_CH)
{
    uint32 flag;
    gI2S_t I2s_Reg;
...
--------------------------------------------------------------------------------
*/
int32 I2SIntDisable(I2S_CHannel I2S_CH,I2S_INT_t INT_TxRx)
{
    gI2S_t I2s_Reg;
    ...
    else
    {
       ...
       //DEBUG("I2s_Reg->I2S_INTCR = 0x%x",I2s_Reg->I2S_INTCR);
...
--------------------------------------------------------------------------------
*/
int32 I2SIntEnable(I2S_CHannel I2S_CH,I2S_INT_t INT_TxRx)
{
    gI2S_t I2s_Reg;
...
----------------------------------------------------------------------*/
uint32 I2sSetSampleRate(I2S_CHannel I2S_CH,I2sFS_en_t I2S_FS)
{
              ...
              I2S_BUS_MODE_t I2S_Bus_mode)
{
   ...
   // DEBUG1("I2s_Reg->I2S_TXCR = 0x%x",I2s_Reg->I2S_TXCR);
    ...
    {
        //get FS Reg config
        FS_Regcofig = I2sSetSampleRate(I2S_CH,I2S_FS);
...
rk_size_t I2S_PIO_Read(I2S_CHannel I2S_CH,uint32* buffer,uint32 size)
{
    gI2S_t I2s_Reg;
...
rk_size_t I2S_PIO_Write(I2S_CHannel I2S_CH,uint32* buffer,uint32 size)
{
    gI2S_t I2s_Reg;
    uint32 dwRealSize, cnt;
