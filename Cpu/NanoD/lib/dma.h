...
//M2LCD
#define     DMA_CTLL_M2LCD_HALF (B_CTLL_DST_TR_WIDTH_16 | B_CTLL_SRC_TR_WIDTH_16 \
                                |B_CTLL_DINC_UNC | B_CTLL_SINC_INC \
                                |B_CTLL_DST_MSIZE_32 | B_CTLL_SRC_MSIZE_32 \
                                |B_CTLL_MEM2MEM_DMAC \
                                |B_CTLL_DMS_AM0  | B_CTLL_SMS_AM1)

#define     DMA_CTLL_M2LCD_WORD (B_CTLL_DST_TR_WIDTH_32 | B_CTLL_SRC_TR_WIDTH_32 \
                                |B_CTLL_DINC_UNC | B_CTLL_SINC_INC \
                                |B_CTLL_DST_MSIZE_32 | B_CTLL_SRC_MSIZE_32 \
                                |B_CTLL_MEM2MEM_DMAC \
                                |B_CTLL_DMS_AM0  | B_CTLL_SMS_AM1)

#define     DMA_CFGL_M2LCD     (B_CFGL_CH_PRIOR(0) | B_CFGL_S_SEL_DST | B_CFGL_S_SEL_SRC)

#define     DMA_CFGH_M2LCD      (B_CFGH_FCMODE | B_CFGH_FIFO_MODE | B_CFGH_PROTCTL)
