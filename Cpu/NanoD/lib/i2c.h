...
//extern int32 I2CSendData(eI2C_CHANNEL i2cPort,UINT8* Databuf,uint32 buflen, BOOL StartBit);
//extern int32 I2CSendData(eI2C_CHANNEL i2cPort,UINT8 slaveaddr, uint regaddr, int reglen, UINT8* Databuf,uint32 buflen/*, BOOL StartBit*/);
