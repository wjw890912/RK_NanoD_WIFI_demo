...
********************************************************************************************
*
*                Copyright (c): 2014 - 2014 + 5, chad.Ma
*                             All rights reserved.
*
...
*******************************************************************************/
_CPU_NANOD_LIB_GPIO_SHELL_
SHELL FUN rk_err_t GPIOBspShellHelp(uint8 * pstr)
{
     pstr--;
    ...
    rk_print_string("gpio命令集提供了一系列的命令对gpio板级驱动接口功能进行测试\r\n");
    rk_print_string("测试命令如下:\r\n");
    rk_print_string("help             gpio测试项说明\r\n");
    rk_print_string("pullup           上拉某一gpio管脚\r\n");
    rk_print_string("pulldown         下拉某一gpio管脚\r\n");
    rk_print_string("in                设置某一gpio管脚为输入方向\r\n");
    rk_print_string("out               设置某一gpio管脚为输出方向\r\n");

    rk_print_string("riseint           测试某一gpio管脚的上升沿中断\r\n");
    rk_print_string("fallint           测试某一gpio管脚的下降沿中断\r\n");
    rk_print_string("lowint            测试某一gpio管脚的低电平中断\r\n");
    rk_print_string("highint           测试某一gpio管脚的高电平中断\r\n");
...
*******************************************************************************/
_CPU_NANOD_LIB_GPIO_SHELL_
SHELL FUN rk_err_t GPIOShellHelp(uint8 * pstr)
{
     pstr--;
    ...
    rk_print_string("测试命令如下:\r\n");
    rk_print_string("help             gpio测试项说明\r\n");
    rk_print_string("bsp              gpio bsp测试项\r\n");
