...
extern uint32 SetSdmmcFreq(Clock_Source_Sel Clk_Source, UINT32 TargetFreqHz);
extern uint32 GetSdmmcFreq(void);

extern uint32 SetSdioFreq(Clock_Source_Sel Clk_Source,UINT32 TargetFreqHz);
extern uint32 GetSdioFreq(void);
