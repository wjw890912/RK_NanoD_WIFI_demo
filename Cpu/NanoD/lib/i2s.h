...
extern int32 I2SIntEnable(I2S_CHannel I2S_CH,I2S_INT_t INT_TxRx);
extern int32 I2SIntDisable(I2S_CHannel I2S_CH,I2S_INT_t INT_TxRx);
...
extern gI2S_t I2sGetCH(I2S_CHannel i2sChNumb);
extern uint32 I2sGetRxFIFOaddr(I2S_CHannel i2sChNumb);
extern uint32 I2sGetTxFIFOaddr(I2S_CHannel i2sChNumb);
extern uint32 I2SGetIntType(I2S_CHannel i2sChNumb);

extern rk_size_t I2S_PIO_Read(I2S_CHannel I2S_CH,uint32* buffer,uint32 size);
extern rk_size_t I2S_PIO_Write(I2S_CHannel I2S_CH,uint32* buffer,uint32 size);
