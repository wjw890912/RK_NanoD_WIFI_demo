...
typedef volatile struct I2sReg{
    ...
    UINT32 I2S_TXDR[(0x7fc-0x404)/4];           //          Transmit Data Register
    UINT32 I2S_RXDR[(0xbfc-0x804)/4];           //          Receive Data Register

} I2SReg_t,*gI2S_t;

#define I2s_Reg         ((I2SReg_t *) I2S0_BASE)
/*
*-------------------------------------------------------------------------------
*
*                         I2S memap register define
...
#define CKR_MDIV_Value              ((UINT32)0x00000001 << 16)
...
#define CLR_RXC_cleard              ((UINT32)0x00000000 << 0)   //This bit can be written only when XFER[1] bit is 0.
