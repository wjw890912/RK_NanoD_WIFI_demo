...
#define UART_CONF               (CRU_BASE + 0xFC)      //uart select config
...
extern int32 UARTSetIOP(eUART_CH uartPort,uint8 useIrDA);
...
extern int32 UARTIntInit(eUART_CH uartPort,eUART_BaudRate baudRate,eUART_dataLen dataBit,eUART_stopBit stopBit,eUART_parity_en parity);
...
extern void UARTSetAutoRTS(eUART_CH uartPort);
/*
********************************************************************************
*
*                         End of uart.h
