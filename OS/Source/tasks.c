...
//rk del start
#if ( configFREE_TASKS_IN_IDLE == 1 )
        //zhuzhe change2014527
        prvCheckTasksWaitingTermination();
#endif
//rk del end
        vTaskFreeTerminated(pxTCB);
...
extern unsigned long Image$$IDLE_STACK$$RW$$Base;
...
void vTaskStartScheduler( void )
{
...
#if ( INCLUDE_xTaskGetIdleTaskHandle == 1 )
    {
        ...
        xReturn = xTaskCreate(prvIdleTask, ( signed char * ) NULL, tskIDLE_STACK_SIZE, ( void * ) NULL, (tskIDLE_PRIORITY | portPRIVILEGE_BIT ), &xIdleTaskHandle, &Image$$IDLE_STACK$$RW$$Base);
    }
#else
    {
        /* Create the idle task without storing its handle. */
        xReturn = xTaskCreate( prvIdleTask, ( signed char * ) NULL, tskIDLE_STACK_SIZE, ( void * ) NULL, ( tskIDLE_PRIORITY | portPRIVILEGE_BIT ), NULL, &Image$$IDLE_STACK$$RW$$Base);
    }
...
static void prvInitialiseTCBVariables( tskTCB *pxTCB, const signed char * const pcName, unsigned portBASE_TYPE uxPriority, const xMemoryRegion * const xRegions, unsigned short usStackDepth )
{
    ...
    //aaron.sun for task remove name 2014828
...
portBASE_TYPE vTaskFreeTerminated( xTaskHandle xTask )
{
